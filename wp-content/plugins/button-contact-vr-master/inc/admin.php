    ...
    <form method="post" action="options.php">
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                ...
                <td><input placeholder="https://www.instagram.com/" type="text" name="pzf_instagram" value="<?php echo esc_attr(get_option('pzf_instagram')); ?>" /></td>
            </tr>
            <tr valign="top" style=" border-bottom: 1px dashed #bfbfbf; ">
                <th scope="row">Color Instagram</th>
                <td>
                    <label for="pzf_color_instagram">
                        <input id="pzf_color_instagram" class="my-color-field" name="pzf_color_instagram" type="text" value="<?php echo esc_attr(get_option('pzf_color_instagram')); ?>" />
                    </label>
                </td>
            </tr>
            <!-- End -->
            ...
            <tr valign="top">
                ...
                <td><input placeholder="" type="text" name="pzf_id_fanpage" value="<?php echo get_option('pzf_id_fanpage'); ?>" /><br>
                    <i>Find your Facebook ID? <a href="https://webvocuc.com/blog/cach-tim-id-fanpage-hieu-qua-va-nhanh-chong.html" target="_blank">help</a> or <a href="https://lookup-id.com/" target="_blank" rel="nofollow">click</a></i>
                </td>
            </tr>
            <tr valign="top">
