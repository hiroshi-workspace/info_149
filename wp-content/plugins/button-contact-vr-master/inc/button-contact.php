	...
	{ ?>
		...
		<div id="button-contact-vr" class="<?php echo $class_active_allinone; ?>">
			<div id="gom-all-in-one"><!-- v3 -->
						...
						<div class="phone-vr">
							...
							<div class="phone-vr-img-circle">
								<a href="<?php echo get_option('pzf_contact_link'); ?>">
									<img src="<?php echo PZF_URL . 'img/facebook.webp'; ?>" />
									<!-- <img src="https://www.iconfinder.com/icons/5296499/fb_facebook_facebook%20logo_icon" alt=""> -->
								</a>
							</div>
						</div>
					</div>
				...
				<!-- Instagram -->
				<?php if (get_option('pzf_instagram')) { ?>
					<!-- <a href="<?php echo esc_url(get_option('pzf_instagram')); ?>" class="contact-button-2" style="background: <?php echo esc_attr(get_option('pzf_color_instagram')); ?>;">
						Liên hệ 2
					</a> -->
					<div id="zalo-vr" class="button-contact">
						<div class="phone-vr">
							<div class="phone-vr-circle-fill instagram-button"></div>
							<div class="phone-vr-img-circle instagram-button">
								<a target="_blank" href="https://www.instagram.com/<?php echo preg_replace('/\D/', '', get_option('pzf_instagram')); ?>">
		...
		<?php if (get_option('pzf_color_phone')) { ?>
			<style>
				...
				#phone-vr .phone-vr-circle-fill {
					opacity: 0.7;
					box-shadow: 0 0 0 0 <?php echo get_option('pzf_color_phone'); ?>;
				}
			</style>
		<?php }; ?>
		<!-- color contact -->
		<?php if (get_option('pzf_color_contact')) { ?>
			<style>
				...
				#contact-vr .phone-vr-circle-fill {
					opacity: 0.7;
					box-shadow: 0 0 0 0 <?php echo get_option('pzf_color_contact'); ?>;
				}
			</style>
		<?php }; ?>
		<!-- color all in one -->
		<?php if (get_option('pzf_color_all_in_one')) { ?>
			<style>
				...
				#all-in-one-vr .phone-vr-circle-fill {
					opacity: 0.7;
					box-shadow: 0 0 0 0 <?php echo get_option('pzf_color_all_in_one'); ?>;
				}
			</style>
		<?php }; ?>
		...
		<?php if (get_option('setting_size')) { ?>
			<style>
				#button-contact-vr {
					transform: scale(<?php echo get_option('setting_size'); ?>);
				}
			</style>
			<?php
