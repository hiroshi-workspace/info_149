				...
				<div class="box <?php echo esc_attr($classes_box); ?> box-blog-post has-hover">
					...
					<div class="box-text <?php echo esc_attr($classes_text); ?>" <?php echo get_shortcode_inline_css($css_args); ?>>
						...
						<div class="box-text-inner blog-post-inner">
							...
							<span class="custom-blog-post">
								<?php if ($show_category !== 'false') { ?>
									<span class="cat-label <?php if ($show_category == 'label') echo 'tag-label'; ?>">
										<?php
								...
								<?php } ?>
								<?php if ((!has_post_thumbnail() && $show_date !== 'false') || $show_date == 'text') { ?><span class="custom-space">-</span><span class="post-meta"><?php echo get_the_date(); ?></span><?php } ?>
							</span>
							...
							<?php if ($show_excerpt !== 'false') { ?>
								<p class="from_the_blog_excerpt <?php if ($show_excerpt !== 'visible') {
																	echo 'show-on-hover hover-' . esc_attr($show_excerpt);
																} ?>">
